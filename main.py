...
class Student:
    def __init__(self, root):
        ...
        text_roll = Entry(Manage_Frame,textvariable = self.Roll_No_var,font =("time new roman",15,"bold"), bd = 5, relief = GROOVE)
        ...
        text_name = Entry(Manage_Frame,textvariable = self.name_var,font =("time new roman",15,"bold"), bd = 5, relief = GROOVE)
        ...
        text_Email = Entry(Manage_Frame,textvariable = self.email_var,font =("time new roman",15,"bold"), bd = 5, relief = GROOVE)
        ...
        text_Contact = Entry(Manage_Frame,textvariable = self.contact_var,font =("time new roman",15,"bold"), bd = 5, relief = GROOVE)
        ...
        text_dob = Entry(Manage_Frame,textvariable = self.dob_var,font =("time new roman",15,"bold"), bd = 5, relief = GROOVE)
        ...
        combo_Search = ttk.Combobox(Detail_Frame,width = 10 ,textvariable = self.search_by,font =("time new roman",15,"bold"),state = 'readonly')
        combo_Search['values'] = ("Roll_no","Name","Contact")
        combo_Search.grid(row = 0, column = 1,padx = 20, pady =10)

        text_search = Entry(Detail_Frame,width = 15,textvariable = self.search_txt,font =("time new roman",13,"bold"), bd = 5, relief = GROOVE)
        ...
        showbtn = Button(Detail_Frame,text = "Show All",command = self.fetch_data, width = 10,pady = 5).grid(row = 0,column = 4, padx = 10, pady =10)
    ...
    def add_students(self):
        if self.Roll_No_var.get()=="" or self.name_var.get()=="" or self.email_var.get()=="" or self.gender_var.get()=="" or self.contact_var.get()=="" or self.dob_var.get()=="" or self.text_Address.get('1.0',END)=="":
            messagebox.showerror("Error","All fields are required !!!")
        else:
            con = pymysql.connect(host = "localhost",user = "root",password = "tiger", database = "stm")
            cur = con.cursor()
